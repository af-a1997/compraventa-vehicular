<?php
    class Sellable{
        ...
        public function ART_ShowOne(){
            $sql_query_list_1_art ="SELECT * FROM $this->tbl WHERE id_art_venta=$this->id_art_venta";
            $retorno = mysqli_query($this->conn, $sql_query_list_1_art);
        ...
        public function ART_EditOne(){
            $sql_query_upd_1_art = "UPDATE $this->tbl SET id_reg_veh=$this->id_reg_veh, divisa_precio=$this->divisa_precio, valor_venta=$this->valor_venta, momento_pub='$this->momento_pub', detalles='$this->detalles', vendedor=$this->vendedor WHERE id_art_venta=$this->id_art_venta;";
            $r = mysqli_query($this->conn, $sql_query_upd_1_art);
            
            return $r;
        }
        
        public function ART_DelOne(){
