...
<?php
    ...
    $o_vcat_info = $o_vcat->VCAT_ShowOne();
?>
...
<html lang="es">
	...
	<body class="g-sidenav-show bg-gray-600 dark-version">
		...
		<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
				...
				<div class="container-fluid py-1 px-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
							...
							<li class="breadcrumb-item text-sm text-white active" aria-current="page"><?php echo a_u_vcat; ?></li>
						</ol>
						
						<h6 class="font-weight-bolder mb-0"><?php echo a_u_vcat.$o_vcat_info->nombre; ?></h6>
					</nav>
            ...
            <form method=POST action="./act/SubmitAct.Del.VCAT.php">
                <input type=hidden name=fln_vcat_id value=<?php echo $o_vcat_info->id_tipo; ?>>
