	...
	<body class="g-sidenav-show bg-gray-600 dark-version">
		...
		<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
            ...
            <div class=danger_area>
                ...
                <p>Estás por <span style="text-transform: lowercase;"><?php echo a_w_con; ?></span> que están inactivos, ¿seguro/a que deseas proceder?</p>
                ...
                <form method=POST action="./act/SubmitAct.FWo.Inact_CON.php">
                    <input type=hidden name=fln_con_fwo_confirmation value=1 />
