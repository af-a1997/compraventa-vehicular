<?php
	...
	$o_con->id_entrada_reg = $_POST['fln_con_id'];
	...
	<body class="g-sidenav-show bg-gray-600 dark-version">
		...
		<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
			...
			<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
				<div class="container-fluid py-1 px-3">
					<nav aria-label="breadcrumb">
						...
						<h6 class="font-weight-bolder mb-0"><?php echo a_s_con.$txc_full_name; ?></h6>
					</nav>
			...
			<?php
				...
				$link_act_1 = BTL_Gen(1,1,"Finish.php?id_con=".$o_con_info->id_entrada_reg);
				
				$r_txc_del = $o_con_info->CON_StopOne();

				if($r_txc_del)
					echo "<p>Contrato de &laquo;".$txc_full_name."&raquo; con &laquo;".$o_con_info->uun."&raquo; detenido".$link_act_0."</p>";
				else
					echo "<p>No se pudo detener el contrato".$link_act_1."</p>";
			?>
		</main>
