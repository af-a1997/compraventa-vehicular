...
<html lang=es>
	...
	<body class="g-sidenav-show bg-gray-600 dark-version">
		...
		<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
			...
			<p>¿Seguro que quieres eliminar el artículo en venta &laquo;<?php echo $full_model; ?>&raquo;? <u>Esta acción no se puede deshacer</u>.</p>
            ...
            <form method=POST action="./act/SubmitAct.Del.Slb.php">
                <input type=hidden name=fln_slb_id_del value=<?php echo $_GET["id_slb"]; ?>>
