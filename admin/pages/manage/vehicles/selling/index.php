...
<html lang="es">
	<head>
		...
		<title>Panel de administrador - <?php echo a_sellman; ?></title>
	</head>
				...
				<div class="container-fluid py-1 px-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
							...
							<li class="breadcrumb-item text-sm text-white active" aria-current="page"><?php echo a_sellman; ?></li>
						</ol>
						
						<h6 class="font-weight-bolder mb-0"><?php echo a_sellman; ?></h6>
					</nav>
						...
						<div class="card my-4">
							<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
								<div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
									<h6 class="text-white text-capitalize ps-3"><?php echo a_sellman; ?></h6>
								</div>
							</div>
									...
									<table class="table align-items-center mb-0">
										...
										<tbody>
											<tr>
												...
												<td class="align-middle text-center text-sm"><a href=#>Fulano</a></td>
												<td class="align-middle text-center text-sm">262000 $U</td>
												<td>
													<p class="text-xs font-weight-bold mb-0">29 de Junio de 2022</p>
													<p class="text-xs text-white opacity-8 mb-0">14:34:20</p>
												</td>
												<td class="align-middle text-center">
													<a href="javascript:;" class="text-white opacity-8 font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Más detalles"><i class="material-icons opacity-10">info</i></a>
