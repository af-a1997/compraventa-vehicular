				...
				<div class="row">
					<div class="col-12">
						<div class="card my-4">
											...
											<?php
												...
												*/
												if($cli_list != ""){
													...
													echo "<tr><td colspan=5 class=\"align-middle text-center text-sm\">No hay clientes registrados, <a href=\"./new\">acá podés registrar uno</a>.</td></tr>";
												}
											?>
										</tbody>
									</table>
							...
							<button class="btn btn-success"><i class="material-icons opacity-10">person_add</i> Registrar cliente</button>
						</div>
					</div>
				</div>
			</div>
